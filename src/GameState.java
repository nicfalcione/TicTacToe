...
public class GameState {
     ...
     * 
     * @param coord coordinate of the board
     * @return true or false
     */
    public static boolean hasToken(int coord) {
        return !TicTacToe.getBoard()[convertRow(coord)][convertCol(coord)]
                .equals("*");
    }
    ...
    public static boolean hasPlayer(int coord) {
        return TicTacToe.getBoard()[convertRow(coord)][convertCol(coord)]
                .equals(TicTacToe.getPlayer().getVal());
    }
    ...
    public static boolean hasCPU(int coord) {
        return TicTacToe.getBoard()[convertRow(coord)][convertCol(coord)]
                .equals(TicTacToe.getCPU().getVal());
    }
